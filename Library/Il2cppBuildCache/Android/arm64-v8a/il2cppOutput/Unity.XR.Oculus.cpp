	...
	{// begin try (depth: 1)
		{
			...
			bool L_5;
			L_5 = NativeMethods_LoadOVRPlugin_mAD824FC278BF51B61D9AEDB9330C05AA8DAE6F29(_stringLiteralDA39A3EE5E6B4B0D3255BFEF95601890AFD80709, /*hidden argument*/NULL);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR String_t* Stats_get_PluginVersion_mE08EA110C75B695B6B2EDC56D7550156AE862E67 (const RuntimeMethod* method)
{
	...
	}
	{
		...
		int32_t L_7;
		L_7 = Array_IndexOf_TisByte_t0111FAB8B8685667EDDAF77683F0D8F86B659056_mF36C8A5539995AE18A947ADB16AA826FEC59526D(L_6, (uint8_t)0, /*hidden argument*/Array_IndexOf_TisByte_t0111FAB8B8685667EDDAF77683F0D8F86B659056_mF36C8A5539995AE18A947ADB16AA826FEC59526D_RuntimeMethod_var);
		V_2 = L_7;
		...
		NullCheck(L_8);
		String_t* L_11;
		L_11 = VirtualFuncInvoker3< String_t*, ByteU5BU5D_tDBBEB0E8362242FA7223000D978B0DD19D4B0726*, int32_t, int32_t >::Invoke(32 /* System.String System.Text.Encoding::GetString(System.Byte[],System.Int32,System.Int32) */, L_8, L_9, 0, L_10);
		IL2CPP_RUNTIME_CLASS_INIT(Stats_t3DD4730256D7A6B7DE1680B2BFB5729B57FBC03F_il2cpp_TypeInfo_var);
...
IL_0018:
	{
		...
		SubsystemManager_GetInstances_TisXRDisplaySubsystem_tF8B46605B6D1199C52306D4EC7D83CFA90564A93_m4568F3C1B27DFC5DA764246D1E0234D371865855(L_4, /*hidden argument*/SubsystemManager_GetInstances_TisXRDisplaySubsystem_tF8B46605B6D1199C52306D4EC7D83CFA90564A93_m4568F3C1B27DFC5DA764246D1E0234D371865855_RuntimeMethod_var);
		...
		L_6 = List_1_GetEnumerator_m0A17C3D1DA735F8334E223C8AC7A727E4B96F81D(L_5, /*hidden argument*/List_1_GetEnumerator_m0A17C3D1DA735F8334E223C8AC7A727E4B96F81D_RuntimeMethod_var);
		V_3 = L_6;
	}
...
IL_002f:
		{
			...
			L_7 = Enumerator_get_Current_m5F43550D048F868C312AA43EC61169DD70A8B8BB_inline((Enumerator_t5D61B75B27E9B563C1DA2AE3CFE072FA106B0828 *)(&V_3), /*hidden argument*/Enumerator_get_Current_m5F43550D048F868C312AA43EC61169DD70A8B8BB_RuntimeMethod_var);
			V_4 = L_7;
			...
			L_9 = IntegratedSubsystem_1_get_SubsystemDescriptor_m6F6551ECCCE19C06B9D8D0103002DBB97C469BA9(L_8, /*hidden argument*/IntegratedSubsystem_1_get_SubsystemDescriptor_m6F6551ECCCE19C06B9D8D0103002DBB97C469BA9_RuntimeMethod_var);
			NullCheck(L_9);
			String_t* L_10;
...
IL_0024:
	{
		...
		NativeMethods_SetPropertyInt_mF6D7BD7C7CFD7E77CA56784655587E9F1B22F0CF((intptr_t)L_4, ((int32_t)15), L_5, /*hidden argument*/NULL);
	}
